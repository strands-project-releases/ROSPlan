## rosplan (indigo) - 0.0.9-0

The packages in the `rosplan` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo rosplan` on `Wed, 14 Sep 2016 14:46:19 -0000`
...
## rosplan (indigo) - 0.0.8-0

The packages in the `rosplan` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo rosplan` on `Mon, 12 Sep 2016 14:11:15 -0000`
...
## rosplan (indigo) - 0.0.7-0

The packages in the `rosplan` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo rosplan` on `Mon, 12 Sep 2016 10:22:55 -0000`
